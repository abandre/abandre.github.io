...
- [09/03/20] - Threads - <a href="/so/Aula4-Threads.pdf" target="_blank">Slide</a>
...
#### 4) Lab 2 - <a href="/so/labs/lab2" target="_blank">Threads</a>
 - Entrega do exercício extra: renomear o arquivo para **XYZ123-threads.zip**, onde XYZ123 é o seu RA.
 - O arquivo zip deve conter o código fonte (.py) e o relatório pedido (.doc ou .pdf) 
