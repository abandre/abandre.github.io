# -*- encoding: utf-8 -*-
# stub: github-pages 226 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<jekyll>.freeze, ["= 3.9.2"])
  ...
  s.add_runtime_dependency(%q<jekyll-commonmark-ghpages>.freeze, ["= 0.2.0"])
  ...
  s.add_runtime_dependency(%q<nokogiri>.freeze, [">= 1.13.4", "< 2.0"])
