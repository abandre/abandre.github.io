# -*- encoding: utf-8 -*-
# stub: github-pages 228 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<jekyll-commonmark-ghpages>.freeze, ["= 0.4.0"])
  s.add_runtime_dependency(%q<liquid>.freeze, ["= 4.0.4"])
  ...
  s.add_runtime_dependency(%q<nokogiri>.freeze, [">= 1.13.6", "< 2.0"])
